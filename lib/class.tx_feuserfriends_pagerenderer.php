 ...
 */
class tx_feuserfriends_pagerenderer
{
	public $conf = array();
	public $extKey = 'feuserfriends';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/feuserfriends/lib/class.tx_feuserfriends_pagerenderer.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/feuserfriends/lib/class.tx_feuserfriends_pagerenderer.php']);
}
